...
enum Localizable {
    ...
    static let home_tab_title = "home_tab_title"
    static let favorites_tab_title = "favorites_tab_title"
    static let channels_btn_title  = "channels_btn_title"
    static let error_enter_valid_url = "error_enter_valid_url"
